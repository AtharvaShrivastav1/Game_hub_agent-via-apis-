...
from app.tools.game_tools import get_user_wallet
...
def chat_with_assistant(payload: ChatRequest):
    ...
    try:
        ...
        return ChatResponse(
            ...
            response=stringify_content(result.get("final_response", "I have processed your request.")),
            requires_approval=requires_approval,
            approval_data=approval_data,
            agent_steps=steps,
            recommended_games=result.get("recommendations", []),
